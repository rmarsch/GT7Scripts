...
Gui, Add, Text, x30 y35, Version 0.6 (Dummy Version)
Gui, Font, cwhite s9 w550 Bold
...
income := credit / (currenttime - starttime) * 3600000
ToolTip,  Race Counts: %racecounter% `nClean Races: %cleanrace% `nAverage Clean Runs: %cleanpercent% Percent `nTotal Earning: %credit%M `nAverage %income%M/hr, 10, 200, screen
